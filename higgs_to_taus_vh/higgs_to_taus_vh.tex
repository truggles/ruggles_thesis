...
\begin{figure}[h!]
 \begin{center}
  \includegraphics[width=0.65\textwidth]{higgs_to_taus_vh/plots/zh/zh_postfit_modRatio.pdf}
 \end{center}
 \caption{The postfit $\mtt$ distributions used to extract the signal shown
...
\begin{figure}[h!]
 \begin{center}
  \includegraphics[width=0.65\textwidth]{higgs_to_taus_vh/plots/wh/wh_postfit_modRatio.pdf}
 \end{center}
