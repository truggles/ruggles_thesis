...
2016 dataset is broken down into different time dependant eras beginning with ``B'' and sequentially
progressing to ``H.'' 
...
as are emposed by the HLT paths.
...
channels as a fit funtion is not used for application of the efficiencies for these channels. 
