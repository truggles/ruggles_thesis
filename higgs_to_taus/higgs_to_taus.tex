...
decaying $\Pgt$ leptons. We study all possible $\Pgt\Pgt$ final state combinations with the
...
of a single isolated muon trigger as well as a cross trigger firing on an isolated muon and
...
from a b-quark are considered if they pass the combined secondard vertex (CSV) version 2 Medium working point are then labeled as b-tagged jets.
