...
\begin{figure*}[htbp]
\centering
     \includegraphics[width=0.65\textwidth]{object_reconstruction_and_selection/plots/CMS-TAU-14-001_tau_mass.pdf}
     \caption{
...
A multivariate (MVA) discriminator~\cite{Hocker:2007ht}, including isolation
