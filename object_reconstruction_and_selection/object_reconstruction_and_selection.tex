...
the PF physics-objects then move to composite objects and full event variables.
...
compliment each other. The CMS detector features: a highly-segmented tracker well
...
\end{outline}
The \texttt{PF ID Medium} muon working is still very efficient for prompt muon selection but
