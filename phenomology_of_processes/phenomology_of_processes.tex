...
and describes left handed fermions.
...
EWSB rescues what would be a colossal disagreement between theoretical prediction
...
similar to what is shown in Figure~\ref{fig:higgs_potential}. Expanding around a chosen minima of the potential
...
Exploring the Higgs boson to fermions decay process is the most promising way to directly probe
...
additional jets. While not having as clear or a handel to separate these events from
the background, these events are kept and are categorized into the less sensitive ``0-Jet'' category.
...
After a Higgs boson is produced, it will decay extremely rapidly. The theorized lifetime of a Higgs
