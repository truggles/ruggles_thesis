...
(pQCD) with the 
\POWHEG 2.0~\cite{Nason:2004rx,Frixione:2007vw, Alioli:2010xd, Alioli:2010xa, Alioli:2008tz} 
generator. The \textsc{minlo hvJ}~\cite{Luisoni:2013kna} extension of \POWHEG 2.0 
is used for the $\PW\PH$ and $\PZ\PH$ simulated samples. 
%The $\ttbar\PH$ process has a is negligible.
The \POWHEG 2.0 generator is used for $\ttbar$, and \POWHEG 1.0 is used for simulating 
