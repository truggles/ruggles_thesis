...
The proton acceleartion chain begins with a bottle of hydrogen gas which feeds hydrogen
into the source chamber of the LINAC2. A large electric field is applied in the source
chaber which breaks the electron-proton bonds separating the electrons from the protons.
...
The path of the proton and proton bunches is controled by magnetic fields throughout
...
The LHC diople magnets must be cooled by liquid helium to 1.9 Kelvin to maintain their superconducting
...
into discrete bunches which can be focused, defocused, and otherwise adjsuted to adjust
...
beam design parameters are detailed in Table~\ref{tab:lhc_beam}.
