...
emanating from the proton-pront collisions. Smooth opertion of the LHC and the delivery
...
under Franch and Switzerland, that was originally used for the Large Electron-Positron (LEP)
...
bend the path of the protons around the circular path of the ring and also to stear
...
of previous accelerators. The LHC acceleration injector chain begins with 1) the LINAC2 linear
accelerator which accelerates protons from essentially rest to an energy of 50 \MeV, 
or $\frac{1}{3}$ the speed of light (c).
The LINAC2 feeds into 1) the Proton Synchrotron Booster circular accelerator boosting
the protons to an energy of 1.4 \GeV, or 91.6\% c., followed by 3) the Proton Synchrotron further
accelerating the protons to 26 \GeV, 99.9\% c. The next stage 4) is the Super Proton Synchrotron
...
The LHC collisions take place at four specified locations around the ring where the two rings
cross each other. The crossing regions are where, when ready, the LHC can stear the proton
...
\subsection{Proton Beam Bending}
