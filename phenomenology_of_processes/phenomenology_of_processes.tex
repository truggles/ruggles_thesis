...
%Then you can introduce the concept that neutrinos are observed to be maximally parity violating and only left-handed. You can then say that only left-handed components of the charged leptons and quarks are introduced in these doublets and the right-handed components are singlets in the SM.  
%You can mention that the right-handed neutrino fields were not included in the SM as the neutrino masses were known to be negligibly small. 
...
\phi = \begin{pmatrix} \phi_{\alpha} \\ \phi_{\beta} \end{pmatrix} = 
    \sqrt{\frac{1}{2}} \begin{pmatrix}\phi_{1} + i\phi_{2} \\ \phi_{3} + i\phi_{4} \end{pmatrix},
...
the Higgs boson Yukawa couplings. The Higgs boson decay processes are discussed below in 
